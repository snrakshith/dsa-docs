---
title: "09 Introducing JavaScript Classes"
description: ""
---
...
I> _Own properties_, properties that occur on the instance rather than the prototype, can only be created inside a class constructor or method. In this example, `name` is an own property. I recommend creating all possible own properties inside the constructor function so a single place in the class is responsible for all of them.
...
W>
W> _ `null`
W> _ generator functions (covered in Chapter 8)
W>
